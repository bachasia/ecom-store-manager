...
export default function ProfitBreakdownChart({ data, loading = false }: ProfitBreakdownChartProps) {
  ...
  if (data.length === 0) {
    return (
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-6">{t('costsAndProfit')}</h3>
